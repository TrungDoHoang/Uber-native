...
Build pewview by EAS (edit in eas.json)

```bash
eas build --platform android --profile preview
```

## <a href="https://www.figma.com/design/sYYXxLpiyU7CkvRljZzCRH/Ryde---Uber-Clone-App?node-id=67003-8417&t=rQUkKXECXSCTGh5D-0" target="_blank">Figma</a>
